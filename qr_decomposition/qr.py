...
def qr_householder(A: np.ndarray):
    """
    Преобразование Хаусхолдер -- линейный оператор вида H = I - 2vv^t, где v -- вектор единичной длины. В частности поз-
    ...
    Итераций столько же, сколько и столбцов. На каждой итерации i мы составляем матрицу Хаусхолдера так, чтобы знанулить,
    элементы A[i:, i], кроме первого.
